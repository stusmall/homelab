...
LD_PRELOAD=$(nix-store -q $(which virsh))/lib/libvirt.so.0 minikube start --cpus='6' -m 24gb --disk-size=80g --extra-config=kubeadm.skip-phases=addon/kube-proxy --driver kvm2
